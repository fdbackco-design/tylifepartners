...
export default function Landing0623Page({
  ...
  useEffect(() => {
    const el = secondSectionRef.current;
    if (!el) return;
  ...
  return (
    <main>
      <LandingAnalyticsTracker landingKey={landingKey} />
