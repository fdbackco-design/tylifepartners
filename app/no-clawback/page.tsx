...
const HERO_LIFE_CARE_1 = "/assets/hero_b2b_v1_1.jpeg";
const HERO_LIFE_CARE_2 = "/assets/hero_b2b_v1_2.jpeg";
...
export default function NoClawbackLandingPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      kp?.track("ViewContent", { page: "no-clawback" });
    }
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.ok) {
        ...
        if (typeof window !== "undefined") {
          const kp = (window as Window & { karrotPixel?: KarrotPixel }).karrotPixel;
          kp?.track("Lead", { page: "no-clawback" });
        }
      } else {
  ...
  return (
    <main>
      ...
      <section style={{ margin: 0, lineHeight: 0, background: "#e9ecef" }}>
        <img
          src={img1Error ? HERO_FALLBACK : HERO_LIFE_CARE_1}
          alt=""
      ...
      <section style={{ margin: 0, lineHeight: 0, background: "#e9ecef" }}>
        <img
          src={img2Error ? HERO_FALLBACK : HERO_LIFE_CARE_2}
          alt=""
          style={{ width: "100%", height: "auto", display: "block", verticalAlign: "bottom" }}
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: 16 }}>
                  <label
                    htmlFor="no-clawback-lead-phone"
                    style={{ display: "block", marginBottom: 6, fontSize: 14, color: "var(--text-secondary)" }}
                  >
                    연락처 (010-0000-0000)
                  </label>
                  <input
                    id="no-clawback-lead-phone"
                    type="tel"
                    value={phone}
                ...
                <div style={{ marginBottom: 16 }}>
                  <label
                    htmlFor="no-clawback-lead-region"
                    style={{ display: "block", marginBottom: 6, fontSize: 14, color: "var(--text-secondary)" }}
                  >
                    지역 (필수)
                  </label>
                  <select
                    id="no-clawback-lead-region"
                    value={region}
                    onChange={(e) => {
                ...
                <div style={{ marginBottom: 16 }}>
                  <label
                    htmlFor="no-clawback-lead-available-time"
                    style={{ display: "block", marginBottom: 6, fontSize: 14, color: "var(--text-secondary)" }}
                  >
                    상담가능시간 (필수)
                  </label>
                  <select
                    id="no-clawback-lead-available-time"
                    value={availableTime}
                ...
                <div style={{ marginBottom: 16 }}>
                  <label
                    htmlFor="no-clawback-lead-age-group"
                    style={{ display: "block", marginBottom: 6, fontSize: 14, color: "var(--text-secondary)" }}
                  >
                    연령대 (필수)
                  </label>
                  <select
                    id="no-clawback-lead-age-group"
                    value={ageGroup}
                ...
                <div style={{ marginBottom: 16 }}>
                  <label
                    htmlFor="no-clawback-lead-job"
                    style={{ display: "block", marginBottom: 6, fontSize: 14, color: "var(--text-secondary)" }}
                  >
                    직업 (선택)
                  </label>
                  <select
                    id="no-clawback-lead-job"
                    value={job}
                    onChange={(e) => {
                ...
                <div style={{ marginBottom: 16 }}>
                  <label
                    htmlFor="no-clawback-lead-job-rank"
                    style={{ display: "block", marginBottom: 6, fontSize: 14, color: "var(--text-secondary)" }}
                  >
                    직급 {job === INSURANCE_DESIGNER_JOB ? "(필수)" : ""}
                  </label>
                  <select
                    id="no-clawback-lead-job-rank"
                    value={jobRank}
