...
const HERO_B2C_2 = "/assets/hero_b2c_02.jpg";
...
export default function MeLandingPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      kp?.track("ViewContent", { page: "self" });
    }
  }, []);
  ...
  return (
    <main>
      ...
      >
        ...
        <h1 style={{ flex: 1, margin: 0, fontSize: 17, fontWeight: 600, textAlign: "center" }}>
          상담 안내
        </h1>
      ...
      <section style={{ margin: 0, lineHeight: 0, background: "#e9ecef" }}>
        <img
          src={img1Error ? HERO_B2C_FALLBACK : HERO_B2C_1}
          alt=""
      ...
      <section style={{ margin: 0, lineHeight: 0, background: "#e9ecef" }}>
        <img
          src={img2Error ? HERO_B2C_FALLBACK : HERO_B2C_2}
          alt=""
          style={{ width: "100%", height: "auto", display: "block", verticalAlign: "bottom" }}
        ...
        <>
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 20 }}>
                <label
                  htmlFor="me-lead-desired-date"
                  style={{ display: "block", marginBottom: 8, fontSize: 18, color: "var(--text-secondary)", fontWeight: 500 }}
                >
                  희망 상담일
                </label>
                <select
                  id="me-lead-desired-date"
                  value={desiredDate}
              ...
              <div style={{ marginBottom: 20 }}>
                <label
                  htmlFor="me-lead-desired-time"
                  style={{ display: "block", marginBottom: 8, fontSize: 18, color: "var(--text-secondary)", fontWeight: 500 }}
                >
                  희망 상담시간
                </label>
                <select
                  id="me-lead-desired-time"
                  value={desiredTime}
