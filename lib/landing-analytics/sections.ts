...
export const LANDING_SECTIONS: Record<LandingKey, LandingSection[]> = {
  ...
  landing_0623: [
    { name: "section_01", label: "1. 메인 후킹", start: 0.0, end: 0.1317 },
    { name: "section_02", label: "2. 왜 선택할까", start: 0.1317, end: 0.2512 },
    { name: "section_03", label: "3. 살아서 체감", start: 0.2512, end: 0.3402 },
    { name: "section_04", label: "4. 좋은 상품", start: 0.3402, end: 0.4338 },
    { name: "section_05", label: "5. 왜 영업인들 선택", start: 0.4338, end: 0.6078 },
    { name: "section_06", label: "6. 판매실적 별 수수료", start: 0.6078, end: 0.6888 },
    { name: "section_07", label: "7. 상품교육", start: 0.6888, end: 0.7661 },
    { name: "section_08", label: "8. 22년 업력", start: 0.7661, end: 0.8507 },
  ...
  landing_0715: [
    { name: "section_01", label: "1. 메인 후킹", start: 0.0, end: 0.01140 },
    { name: "section_02", label: "2. 왜 선택할까", start: 0.01140, end: 0.2408 },
    { name: "section_03", label: "3. 살아서 체감", start: 0.2408, end: 0.3209 },
    { name: "section_04", label: "4. 좋은 상품", start: 0.3209, end: 0.4240 },
    { name: "section_05", label: "5. 왜 영업인들 선택", start: 0.4240, end: 0.6141 },
    { name: "section_06", label: "6. 판매실적 별 수수료", start: 0.6141, end: 0.6916 },
    { name: "section_07", label: "7. 상품교육", start: 0.6916, end: 0.7679 },
    { name: "section_08", label: "8. 22년 업력", start: 0.7679, end: 0.8514 },
    { name: "section_09", label: "9. 파트너 상담 신청", start: 0.8514, end: 0.9259 },
    { name: "section_10", label: "10. 약관", start: 0.9259, end: 1.0 },
  ],
  landing_0715s: [
    { name: "section_01", label: "1. 메인 후킹", start: 0.0, end: 0.01140 },
    { name: "section_02", label: "2. 왜 선택할까", start: 0.01140, end: 0.2408 },
    { name: "section_03", label: "3. 살아서 체감", start: 0.2408, end: 0.3209 },
    { name: "section_04", label: "4. 좋은 상품", start: 0.3209, end: 0.4240 },
    { name: "section_05", label: "5. 왜 영업인들 선택", start: 0.4240, end: 0.5950 },
    { name: "section_06", label: "6. 판매실적 별 수수료", start: 0.5950, end: 0.6822 },
    { name: "section_07", label: "7. 상품교육", start: 0.6822, end: 0.7658 },
    { name: "section_08", label: "8. 22년 업력", start: 0.7658, end: 0.8474 },
